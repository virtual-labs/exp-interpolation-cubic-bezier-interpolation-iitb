...
function activity1() {
    ...
    <div class='divide'>
        <div style='margin-top: 2vw;'>
            <br>
            <h4 class="center-text fs-20px fw-600">Interpolation: Cubic Bezier Interpolation</h4>
...
function start_act1() {
    ...
    <div class='collapse center-text divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb1-box'>
        ...
        $$ x(u) = x_0(1-u)^3 + x_1 3 u * (1-u)^2 + x_2 3 u^2 * (1-u) + x_3 u^3 $$
        $$ y(u) = y_0(1-u)^3 + y_1 3 u * (1-u)^2 + y_2 3 u^2 * (1-u) + y_3 u^3 $$
